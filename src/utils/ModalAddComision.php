...
function generateModalComision()
{
    ...
    <div class=\"modal comision\">
        <div class=\"modal_content\">
            ...
            <div class=\"modal_body\">
                <form action=\"admin_home.php?page=commissions&action=addCommissions\" method=\"POST\" enctype=\"multipart/form-data\">
    ...
    $modal .= "
            ...
            <div class=\"input_group\">
                ...
                <select id=\"viaticos\" name=\"viaticos\" required onchange=\"toggleViaticosField()\">
            ...
            <div class=\"input_group\">
                ...
                <select id=\"transporte\" name=\"transporte\" required onchange=\"toggleTransporteFields()\">
                    <option value=\"No\">No</option>
                    <option value=\"Si\">Sí</option>                   
                </select>
            </div>
            ...
            <div id=\"transporte_fields\" style=\"display: none;\">
                <div class=\"input_group\">
                    ...
                    <select id=\"transporte_propio\" name=\"transporte_propio\" onchange=\"toggleKilometrajeField()\">                       
                    <option value=\"No\">No</option>
                    <option value=\"Si\">Sí</option>
                    </select>
                </div>
...
<script>
    ...
    function saveLocation() {
        if (marker) {
            ...
            document.getElementById(\"lugar\").value = latlng.lat + \", \" + latlng.lng;
            closeMapModal();
        } else {
